        ...
        <ul class="nav navbar-right top-nav">
                        ...
                        <a href="#">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><strong><?php session_start(); echo $_SESSION['fname']. ' '. $_SESSION['lname']?></strong>
                                    </h5>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php
                    session_start(); echo $_SESSION['fname']. ' '. $_SESSION['lname']?> <b class="caret"></b></a>
